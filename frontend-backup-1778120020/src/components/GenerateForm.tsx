...
export default function GenerateForm({ topics = [], onSubmit }: GenerateFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    onSubmit?.({ difficulty, count, topics: selectedTopics });
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block font-mono text-[0.7rem] uppercase tracking-[0.12em] text-[#5a7298] mb-4">
          Topics
          <span className="ml-2 text-[#8ba3c7] normal-case">
